...
import 'package:minor_project/Services/marker_service.dart';
import 'package:provider/provider.dart';
import 'package:url_launcher/url_launcher.dart';

class NearbyParkingsList extends StatefulWidget {
  @override
  _NearbyParkingsListState createState() => _NearbyParkingsListState();
}

class _NearbyParkingsListState extends State<NearbyParkingsList> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Nearby Parkings List"),
        centerTitle: true,
      ),
      body: FutureProvider(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                (places[index].rating != null) ? Row(
                                  children: [
                                    RatingBarIndicator(rating: places[index].rating,
